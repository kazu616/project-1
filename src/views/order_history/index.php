                ...
                <div class="flex items-center justify-center px-4 py-10 lg:px-0 sm:px-6">
                    <div class="flex items-center justify-between w-full border-t border-gray-200 lg:w-3/5">
                        ...
                        <div class="hidden sm:flex">
                            <p class="px-2 pt-3 mr-4 text-sm font-medium leading-none text-gray-600 border-t border-transparent cursor-pointer hover:text-indigo-700 hover:border-indigo-400">
                                1</p>
                            <p class="px-2 pt-3 mr-4 text-sm font-medium leading-none text-gray-600 border-t border-transparent cursor-pointer hover:text-indigo-700 hover:border-indigo-400">
                                2</p>
                            <p class="px-2 pt-3 mr-4 text-sm font-medium leading-none text-gray-600 border-t border-transparent cursor-pointer hover:text-indigo-700 hover:border-indigo-400">
                                3</p>
                            <p class="px-2 pt-3 mr-4 text-sm font-medium leading-none text-indigo-700 border-t border-indigo-400 cursor-pointer">
                                4</p>
                            <p class="px-2 pt-3 mr-4 text-sm font-medium leading-none text-gray-600 border-t border-transparent cursor-pointer hover:text-indigo-700 hover:border-indigo-400">
                                5</p>
                            <p class="px-2 pt-3 mr-4 text-sm font-medium leading-none text-gray-600 border-t border-transparent cursor-pointer hover:text-indigo-700 hover:border-indigo-400">
