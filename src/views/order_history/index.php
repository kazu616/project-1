                        ...
                        <div class="w-full rounded-[20px] bg-white p-5">
                            ...
                            <div class="flex justify-end gap-x-5">
                                ...
                                <form action="?controller=order_history&action=update&id=<?= $each['order']['idOrder'] ?>&status=3" method="post">
                                    <?php if ($each['order']['status'] == DELIVERING) { ?><button class="px-3 py-2 bg-[#FF6B00] text-white font-semibold rounded-[10px] <?= $each['order']['status'] != 2 ? "!bg-[#888] !select-none" : "" ?>">Received
