        ...
        <div class="flex-1 rounded-[10px]">
            <div class="flex items-center justify-between bg-[#EDEBE4] mb-10">
                <a href="?controller=order_history"
                    class="flex items-center justify-center px-10 py-5 text-xl font-semibold uppercase border-b-2 cursor-pointer <?= isset($_GET['status']) ? "" : "border-red-500  text-red-500" ?>">All</a>
                <a href="?controller=order_history&status=1"
                    class="flex items-center justify-center px-10 py-5 text-xl font-semibold border-b-2 uppercase cursor-pointer <?= isset($_GET['status']) ? ($_GET['status'] == 1 ? "text-red-500 border-red-500" : "") : ""  ?>">Pending</a>
                <a href="?controller=order_history&status=2"
                    class="flex items-center justify-center px-10 py-5 text-xl font-semibold border-b-2 uppercase cursor-pointer <?= isset($_GET['status']) ? ($_GET['status'] == 2 ? "text-red-500 border-red-500" : "") : ""  ?>">Transport</a>
                <a href="?controller=order_history&status=3"
                    class="flex items-center justify-center px-10 py-5 text-xl font-semibold border-b-2 uppercase cursor-pointer <?= isset($_GET['status']) ? ($_GET['status'] == 3 ? "text-red-500 border-red-500" : "") : ""  ?>">Complete</a>
                <a href="?controller=order_history&status=4"
                    class="flex items-center justify-center px-10 py-5 text-xl font-semibold border-b-2 uppercase cursor-pointer <?= isset($_GET['status']) ? ($_GET['status'] == 4 ? "text-red-500 border-red-500" : "") : ""  ?>">Cancelled</a>
            </div>
                  ...
                  case CANCELED:
                    ...
                    <div class="flex justify-end gap-x-5">
                        ...
                        <form
                            ...
                            method="post">
                            <button
                                class="px-3 py-2 bg-[#FF6B00] text-white font-semibold rounded-[10px] <?= $each['order']['status'] != 2 ? "bg-[#888]" : "" ?>">Received
                                The Confirme</button>
                        </form>
                ...
                <div class="flex items-center justify-center px-4 py-10 lg:px-0 sm:px-6">
                    <div class="flex items-center justify-between w-full border-t border-gray-200 lg:w-3/5">
                        ...
                        <div class="hidden sm:flex">
                            <p
                                class="px-2 pt-3 mr-4 text-sm font-medium leading-none text-gray-600 border-t border-transparent cursor-pointer hover:text-indigo-700 hover:border-indigo-400">
                                1</p>
                            <p
                                class="px-2 pt-3 mr-4 text-sm font-medium leading-none text-gray-600 border-t border-transparent cursor-pointer hover:text-indigo-700 hover:border-indigo-400">
                                2</p>
                            <p
                                ...
                                3</p>
                            <p
                                class="px-2 pt-3 mr-4 text-sm font-medium leading-none text-indigo-700 border-t border-indigo-400 cursor-pointer">
                                4</p>
                            <p
                                class="px-2 pt-3 mr-4 text-sm font-medium leading-none text-gray-600 border-t border-transparent cursor-pointer hover:text-indigo-700 hover:border-indigo-400">
                                5</p>
