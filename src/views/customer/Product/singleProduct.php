            ...
            <div class="flex justify-center p-10 ">
                ...
                <div class="w-[390px] h-[513px]">
                    <img src="imgs/<?= $product['img'] ?>"
                        class="object-contain w-[390px] h-[508px]  relative top-3 right-[50%] " />
                </div>
                ...
                <div class="flex flex-col relative top-16 right-[5%] gap-3">
                    ...
                    <p>
                        ...
                        <span id="totalProduct"
                            class="text-base font-bold font-secondary text-left text-[#888]"><?= $product['amount'] ?></span>
                    </p>
                    <p class="pb-5 pt-2">
                    ...
                    <div class="flex gap-4 pt-2 pb-3">
                        ...
                        <div
                            class="flex items-center bg-[#E2E2E2] h-8 rounded-md text-center relative bottom-[10px] font-secondary">
                    ...
                    <div class="flex gap-3">
                        <input id="data" name="" type="hidden" value="<?= $product['idProduct'] ?>" />
