    ...
    <div class="w-[1536px] h-[864px] relative overflow-hidden rounded-[27.2px] bg-white border-[8px] border-white mx-auto transform translate-y-[3.5%]"
        ...
        <div class="w-[991.2px] h-[980px]">
            ...
            <div class="w-[887.2px] h-[864px] absolute left-[-0.4px] top-[-0.4px] bg-[#ffe6c9]">
                ...
                <svg width="133.6" height="65.6" viewBox="0 0 167 82" fill="none" xmlns="http://www.w3.org/2000/svg"
                    class="absolute left-[815px] top-[780px] opacity-40" preserveAspectRatio="none">
                    <path opacity="1"
                        d="M83.4999 167C129.616 167 167 129.616 167 83.5C167 37.3842 129.616 0 83.4999 0C37.3842 0 0 37.3842 0 83.5C0 129.616 37.3842 167 83.4999 167Z"
                        fill="url(#paint0_linear_36_108)"></path>
                    <defs>
                        <linearGradient id="paint0_linear_36_108" x1="160.074" y1="116.862" x2="6.88778" y2="50.177"
            ...
            <div class="flex flex-col justify-center items-center absolute left-[1048px] top-[115px] gap-7">
                ...
                <button
                    class="w-[336px] p-2 rounded-[5px] border border-[#e8e8e8] flex justify-center items-center gap-[10px]">
                ...
                <form class="flex flex-col items-start justify-start gap-6" onsubmit="return validate_login()"
                    id="form_login" class="form" method="POST" action="index.php?controller=user&action=loginAccess">
                    <div class="flex flex-col items-start justify-start gap-2">
                        <label for="email_login" class="text-sm font-semibold text-left text-[#828282]">Email</label>
                        <input id="email_login" required type="email_login" name="email_login"
                            placeholder="abc@mail.com"
                            class="w-[336px] px-2 py-[10px] rounded-[5px] border border-[#ded2d9]" />
                        <span class="form-message text-[12px] text-red-400"></span>
                    </div>
                    <div class="flex flex-col items-start justify-start gap-2">
                        <label for="password_login"
                            class="text-sm font-semibold text-left text-[#828282]">Password</label>
                        <input id="password_login" required type="password" name="password_login"
                            placeholder="***************"
                            class="w-[336px] px-2 py-[10px] rounded-[5px] border border-[#ded2d9]" />
                        <span class="form-message text-[12px] text-red-400"></span>
                    </div>
                    <input type="submit"
                        class="w-[336px] px-2 py-2 rounded-md bg-[#7f265b] cursor-pointer text-white hover:bg-black duration-150"
                        name="login" />
                </form>
            </div>
            <!-- đăng ký footer -->
