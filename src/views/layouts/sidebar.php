<nav>
            ...
            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                <g id="Artboard" transform="translate(-95.000000, -51.000000)">
                    <g id="logo" transform="translate(95.000000, 50.000000)">
                        ...
                        <path id="Rectangle" fill-opacity="0.15" fill="#FFF" d="M3.04512412,1.86636639 L15,9.19354839 L15,9.19354839 L15,17.1774194 L0,8.58649679 L0,3.5715689 C3.0881846e-16,2.4669994 0.8954305,1.5715689 2,1.5715689 C2.36889529,1.5715689 2.73060353,1.67359571 3.04512412,1.86636639 Z">
                        </path>
    ...
    <ul>
        ...
        <a href="?controller=accountAdmin&action=">
    ...
    <span class="title-link">SEO</span>
    <ul>
        <a href="?controller=seo">
            <li class=<?php echo isset($_GET["controller"])  ? ($_GET["controller"] == "seo" ? "activeLink" : "") : "" ?>>
                <box-icon type='solid' name='envelope'></box-icon>
                <span>Export list email</span>
            </li>
        </a>
    </ul>
</nav>