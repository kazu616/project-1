    ...
    <main>
        ...
        <div class="content" style="flex-direction: column">
            ...
            <form method="POST" class="form-basic" autocomplete="off" enctype="multipart/form-data"
                action="index.php?controller=productAdmin&action=edit">
                <input type="hidden" value="<?= $data_product['idProduct'] ?>" name="id" />
                <input type="hidden" value="<?= $data_product['img'] ?>" name="old_img" />
                <div class="form-field">
                    <input type="text" name="name" value="<?= $data_product['name'] ?>" required class="form-input"
                        placeholder=" " />
                    <label class="form-label">Name</label>
                </div>
                <div class="form-field">
                    <input type="number" value="<?= $data_product['price'] ?>" name="price" required class="form-input"
                        id="price" placeholder=" " />
                    <label class="form-label">Price</label>
                </div>
                <div class="form-field">
                    <input type="number" required value="<?= $data_product['amount'] ?>" class="form-input"
                        name="amount" placeholder=" " />
                    <label class="form-label">Amount</label>
                </div>
                <div class="form-field">
                    <input id="issuingDate" type="date" id="release_date_input"
                        value="<?= $data_product['issuingDate'] ?>" class="form-input" name="issuingDate"
                        placeholder=" " />
                ...
                <div class="form-field">
                    <textarea type="text" required class="form-input" style="height: 150px;" name="description"
                        placeholder=" "><?= $data_product['description'] ?></textarea>
