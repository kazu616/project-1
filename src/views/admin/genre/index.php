    ...
    <main>
        ...
        <div class="flex-2">
            ...
            ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="?controller=genreAdmin&action=destroy&id=<?= $row['idGenre'] ?>"
            ...
            <div class="content" style="flex-direction: column">
                ...
                <form method="POST" class="form-advance"
                    action="?controller=genreAdmin&action=<?= isset($_GET['edit']) ? "edit&id=" . $_GET['id'] : "add"  ?>"
                    autocomplete="off">
                    <div class="form-field">
                        <input type="text" required value="<?= isset($_GET["id"]) ? $array['itemEdit']['name'] : "" ?>"
                            class="form-input" id="product-genre" name="name" placeholder=" " />
